...
namespace _201518100120
{
    ...
    public sealed class ToolBufferAnalysis : BaseTool
    {
        ...
        public override void OnClick()
        {
            ...
            if (m_hookHelper.FocusMap.LayerCount <= 0)//判断有无图层
            {
        ...
        public override void OnMouseDown(int Button, int Shift, int X, int Y)
        {
            ...
            pGraCont.DeleteAllElements();//清除地图上添加的所有Element
            var pPoint = pActiveView.ScreenDisplay.DisplayTransformation.ToMapPoint(X, Y);//点击位置转化为点图形要素
            var pFeatureLayer = m_hookHelper.FocusMap.Layer[0] as IFeatureLayer;//获取地图中的图层
            ...
            if (pFeature != null && pFeature.Shape.GeometryType == esriGeometryType.esriGeometryPolygon)//是一个面对象
            {
                var pGeometry = pFeature.Shape;//获取形状
                ...
                //将渲染之后的多边形添加到IGraphicscontainer层中
